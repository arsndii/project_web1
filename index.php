<?php
    ...
    $query = mysqli_query($con,"SELECT * FROM posting ORDER BY tanggal DESC LIMIT 10");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <table>
            <tbody>
              <th>
                ...
                <tr>
                  <a href="#posting" class="text-light" style="text-decoration:none"> | Posting </a>
                </tr>
                <tr>
      ...
      <div class="row pt-3 pb-3" style="min-height: 720px">
        ...
        <div class="col-md-9">
          ...
          <div class="row pb-3" id="home">
            <h2>Hello World !</h2>
            <p>Welcome, this is my first personal website, this website is built using the <a href="https://getbootstrap.com/" class="text-dark" style="text-decoration:none">Bootstrap</a> framework.</p>
          </div>
          <!-- Postingan -->
          <div class="row text-center justify-content-center gap-3" id="posting">
            <h3 class="pt-1 pb-1">Postingan Terbaru</h3>
